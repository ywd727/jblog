...
import top.jxx.config.properties.TelegramProperties;
import top.jxx.entity.Comment;
...
import top.jxx.util.comment.CommentUtils;
...
public class TelegramBotMsgHandler {
	...
	private String replyComment(String msgContent) {
		...
		if (splitIndex2 != -1 && msgContent.length() > splitIndex2 + 1) {
			...
			top.jxx.model.dto.Comment comment = new top.jxx.model.dto.Comment();
