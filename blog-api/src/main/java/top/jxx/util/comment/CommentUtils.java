...
import top.jxx.constant.PageConstants;
import top.jxx.constant.RedisKeyConstants;
import top.jxx.entity.User;
import top.jxx.model.dto.Comment;
...
import top.jxx.util.IpAddressUtils;
import top.jxx.util.MailUtils;
import top.jxx.util.QQInfoUtils;
import top.jxx.util.StringUtils;
import top.jxx.util.comment.channel.ChannelFactory;
import top.jxx.util.comment.channel.CommentNotifyChannel;
import top.jxx.enums.CommentOpenStateEnum;
import top.jxx.enums.CommentPageEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, top.jxx.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(top.jxx.entity.Comment parentComment, Comment comment) {
