package top.jxx.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import top.jxx.entity.ScheduleJobLog;
import top.jxx.service.ScheduleJobService;
import top.jxx.util.common.SpringContextUtils;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		top.jxx.entity.ScheduleJob scheduleJob = (top.jxx.entity.ScheduleJob) context.getMergedJobDataMap().get(top.jxx.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
