...
import top.jxx.entity.LoginLog;
import top.jxx.entity.User;
import top.jxx.exception.BadRequestException;
import top.jxx.model.vo.Result;
import top.jxx.service.LoginLogService;
...
public class JwtLoginFilter extends AbstractAuthenticationProcessingFilter {
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
		...
		//将获取到的登录token放入到redis的缓存中
		System.out.println("redisService = " + redisService);
//		redisService.saveObjectToValue("token", jwt );
