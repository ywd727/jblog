<template>
	<header ref="header">
		<div class="view">
			<img ref="imgbg1" src="/img/one.jpg" style="display: none;">
...
<!--      <div class="bg3" style="background-image: url('https://fastly.jsdelivr.net/gh/Nachttps://blog-jian.oss-cn-hangzhou.aliyuncs.com/QQ%E5%9B%BE%E7%89%8720201112143441.jpg');" v-show="loaded"></div>-->
      <div class="bg1" style="background-image: url('/img/one.jpg');"></div>
      <div class="bg2" style="background-image: url('/img/two.jpg');"></div>
      <div class="bg3" style="background-image: url('/img/three.jpg');" v-show="loaded"></div>
    </div>
		<div class="text-malfunction" data-word="Jian's Blog">
			<div class="line"></div>
		</div>
		<div class="wrapper">
